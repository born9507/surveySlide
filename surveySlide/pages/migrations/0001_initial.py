# Generated by Django 3.0.7 on 2020-08-07 16:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choosed_users', models.ManyToManyField(blank=True, related_name='choose_choice', through='pages.Answer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Question',
        ...
        migrations.AddField(
            model_name='answer',
            name='choice',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pages.Choice'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
